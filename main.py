...
# Store the predicted parameters in arrays
    np.save(os.path.join(record_dir, 'predicted_params.npy'), preds)
    np.save(os.path.join(record_dir, 'true_params.npy'), trues)
