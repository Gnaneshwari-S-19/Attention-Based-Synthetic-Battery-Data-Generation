...
class Dataset_hour(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 target='Current', scale=True, timeenc=0, freq='h'):
...
class Dataset_minute(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='M', data_path='dataset3.csv',
                 target='Current', scale=False, timeenc=0, freq='t'):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='M', data_path='data.csv',
                 target='Current', scale=False, timeenc=0, freq='h'):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
